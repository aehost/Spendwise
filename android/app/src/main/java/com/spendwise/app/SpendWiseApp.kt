...
class SpendWiseApp : Application(), Configuration.Provider {
    ...
    private fun scheduleBackgroundWork() {
        ...
        // Note: Gmail sync runs via GmailImapWorker (App Password IMAP), scheduled
        // from MainActivity. The old OAuth GmailSyncWorker was removed — it could
        // never work without Google Cloud (google-services.json / SHA-1) setup.
    }
}
